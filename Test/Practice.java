...
//
//      i = 0;
//      while ((i < baseTableLength) && keepLooking) { // search here refers to the salary amount, ex: 40000
//         if (search <= baseTable[i]) {   //base table here refers to salary base table in the main method
//            value = valueTable[i];   //value table refers to the amount of taxes needed to pay
//            keepLooking = false;
//         }
//         else {
//            ++i;
